...
public class ProjectDao {
	...
	public boolean addProject(Project obj) throws Exception {
		...
		try {
			...
			String insertQry = "INSERT INTO [MasterDB].[dbo].[project] (project_name,project_code,company_code,sbu_code,status,created_by) VALUES (:project_name,:project_code,:company_code,:sbu_code,:status,:created_by)";
	...
	public boolean updateProject(Project obj) throws Exception {
		...
		try {
			NamedParameterJdbcTemplate namedParamJdbcTemplate = new NamedParameterJdbcTemplate(dataSource);
			String updateQry = "UPDATE  [MasterDB].[dbo].[project] set project_name= :project_name,company_code= :company_code,sbu_code= :sbu_code,project_code= :project_code,status=:status,modified_by= :modified_by "
					+ " where id= :id ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
