...
<head>
  ...
  <title>RE - SignUp</title>
    <link rel="icon" type="image/png" href="/reelweighbridges/resources/images/favicon.png" />
	<script src="/reelweighbridges/resources/js/jQuery-v.3.5.min.js"  ></script>
    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" href="/reelweighbridges/resources/vendor/css/pages/page-auth.css">
 ...
 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css">
   ...
   <link rel="stylesheet" type="text/css" href="/reelweighbridges/resources/vendors/css/forms/select/select2.min.css">
    ...
    <!-- END: Page CSS-->
      <link rel="stylesheet" type="text/css" href="/reelweighbridges/resources/vendors/css/file-uploaders/dropzone.min.css">
    <link rel="stylesheet" type="text/css" href="/reelweighbridges/resources/css/plugins/forms/form-file-uploader.min.css">
    <!-- BEGIN: Custom CSS-->
                ...
                >
                  ...
                  <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="Artboard" transform="translate(-400.000000, -178.000000)"> 
			         <img src="<%=request.getContextPath() %>/resources/images/logo/logo-scs-key523173.png" width="" height="65" class="card-imgs" >
                    </g>
                  </g>
                </svg> 
...
<div class="col-lg-12 col-sm-12 col-12" style="box-sizing:border-box; display:table;">
 ...
 <script src="/reelweighbridges/resources/js/materialize-v.1.0.min.js "  ></script>
   ...
   <script src="/reelweighbridges/resources/js/scripts/pages/modal-add-new-cc.min.js"></script>
    ...
    <script src="/reelweighbridges/resources/vendors/js/file-uploaders/dropzone.min.js"></script>
    <script src="/reelweighbridges/resources/js/scripts/forms/form-file-uploader.min.js"></script>
